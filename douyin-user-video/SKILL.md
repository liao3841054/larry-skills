...
description: "抖音无水印视频下载、文案提取和博主主页视频解析工具. 从抖音分享链接获取无水印视频下载链接, 下载视频, 提取视频中的语音文案并自动保存到文件; 也支持从抖音用户主页链接解析视频列表. 适用场景包括获取抖音视频信息, 下载无水印视频, 批量提取视频文案, 获取博主主页视频清单. 当用户需要处理抖音视频链接或主页链接时触发."
---
...
# 解析博主主页视频列表并输出 JSON
python douyin_user_videos.py --url "https://www.douyin.com/user/MS4wLjABAAAA4LqLxq7PLK9xEB5PPazcKTG-3oInPFTDwbqiSrRL_mg?f" --output ./douyin_user_videos.json
```
